          ...
          <div className="h-14 flex items-center justify-between px-4 border-b border-graphite-700 shrink-0">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <a
                ...
                className="flex items-center gap-1.5 text-graphite-300 hover:text-blueprint-400 text-xs px-2.5 py-1.5 rounded-md hover:bg-graphite-800 transition-colors"
              >
              ...
              <button
                onClick={closeViewer}
                className="p-1.5 text-graphite-300 hover:text-graphite-100 hover:bg-graphite-800 rounded-md transition-colors"
              >
